$(document).ready(function() {
	...
	function initialScreen() { // Button that displays after the lessons are done
		startExperienceScreen = "<p class='text-center main-button-container'><a class='btn btn-primary btn-lg btn-block start-button' href='#' role='button'>Begin your quiz!</a></p>";
	...
	function generateLossDueToTimeOut() {
		unansweredTally++;
		gameHTML = "<p class='text-center timer-p'><span class='timer'>" + counter + "</span></p>" + "<p class='text-center'>You ran out of time!  The correct answer was: " + correctAnswers[questionCounter] + "</p>" + "<img class='center-block img-wrong' src='img/x.png'>";
	...
	function finalScreen() {
		gameHTML = "<p class='text-center timer-p'> <span class='timer'>" + counter + "</span></p>"+ "<p class='text-center'>Good job" + "</p>" + "<ul class='result-display'><li class='summary-correct'>Correct Answers<br/><span class='result-number'>" + correctTally + "</span></li>" + "<li>Wrong Answers<br/><span class='result-number'>" + incorrectTally + "</span></li>" + "<li>Unanswered<br/><span class='result-number'>" + unansweredTally + "</span></li></ul>"+ "<p class='text-center'>You got: " + correctTally +"/"+ 10 + "</p>" + "<p class='text-center reset-button-container'><a class='btn btn-primary btn-lg btn-block reset-button' href= 'lesson_outline.html' role='button'>Next Lesson</a></p>";
		$(".experienceArea").html(gameHTML);
	}
	function finalFailScreen() {
		gameHTML = "<p class='text-center timer-p'><span class='timer'>" + counter + "</span></p>" + "<p class='text-center'>All done, here's how you did!" + "</p>" + "<p class='text-center'>Try again" + "</p>" +"<ul class='result-display'><li class='summary-correct'>Correct Answers<br/><span class='result-number'>" + correctTally + "</span></li>" + "<li>Wrong Answers<br/><span class='result-number'>" + incorrectTally + "</span></li>" + "<li>Unanswered<br/><span class='result-number'>" + unansweredTally + "</span></li></ul>"+ "<p class='text-center'>You got: " + correctTally +"/"+ 10 + "</p>" + "<p class='text-center reset-button-container'><a class='btn btn-primary btn-lg btn-block reset-button' href='lesson_outline.html' role='button'>Reset The Quiz!</a></p>";
		$(".experienceArea").html(gameHTML);
	}
